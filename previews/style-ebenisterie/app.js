...
(() => {
  ...
  async function init() {
    ...
    try {
      ...
      console.error("[Armoires Exemple] Impossible de charger content.json:", err);
      showLoadError();
      return;
    }
  ...
  function initCareers() {
    ...
    if (form) {
      form.addEventListener("submit", (e) => {
        ...
        window.location.href = "mailto:emplois@exemple.ca?subject=" + subject + "&body=" + body;
      });
    }
  }
  ...
  const isMedia = (n) => { n = n.toLowerCase(); return [".svg", ".jpg", ".jpeg", ".png", ".webp", ".gif", ".avif", ".mp4", ".webm", ".mov"].some((e) => n.endsWith(e)); };
